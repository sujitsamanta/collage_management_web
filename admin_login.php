...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["login"])) {
        ...
        if (empty($l_name) || empty($l_password)) {
            ...
            $sql = "SELECT *FROM adminlogin WHERE name='$l_name' AND password='$l_password'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                header("Location: admin_dasbord/admin_home.php");
            } else {
                $alert2 = true;
            }
        }
        ...
        <form id="loginForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
            ...
            <?php if ($alert2): ?>
                <div class="form-group"
                    ...
                    <label>Incorrect user id or password..!</label>
                </div>
            <?php endif; ?>
